...
public class XPathEngineTest extends TestCase
{
	 ...
	 */
	@Test
	public void testXPathAllValid() throws UnknownHostException, IOException, SAXException, ParserConfigurationException
	{
		// get all the xPaths
		String xPath = "/node;"
	...
	/**
	 * This method tests 5 invalidity cases for the xpaths - no axis, no step, //, unknown symbols and non closed brackets
	 * @throws UnknownHostException
	 * @throws IOException
	 * @throws SAXException
	 * @throws ParserConfigurationException
	 */
	@Test
	public void testXPathAllInvalid() throws UnknownHostException, IOException, SAXException, ParserConfigurationException
	{
		// get all the xPaths
		String xPath = "/;"
				+ "node[a/b/c[subnode]]/sub-subnode;"
