...
$acctKey = 'VLBR/yvFiIB5fu/bRQd23jPLsKTDQhdJ0nUCAZvWF2I=';
$rootUri = 'https://api.datamarket.azure.com/Bing/Search';

// Get the query. Default to 'sushi'.
$query = ($_GET['q']) ? $_GET['q'] : 'cis455';
...
<!-- https://api.datamarket.azure.com/Bing/Search/Web?format=json&Query=pig&Market=en-us -->